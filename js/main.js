    ...
    class Item {
		...
		// Create new object: DOM
		const DOM = {};
		// Add .grid as property
    ...
    DOM.details = new Details();
		...
		// images Loaded JS from Dave Desandro:
		// When all images are loaded in the body tag, remove 'loading' class from the body tag
